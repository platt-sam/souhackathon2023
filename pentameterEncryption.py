import requests
import math
from isPentameter import isPentameter
...
#driver 
#makes a second API round call which is not great, but its what i had time for. 
if isPentameter(testString):
    ...
    print("error I can only encrypt strings that are a multiple of 10 syllables long")